...
type IServiceCollection with
    member this.AddTodoInMongoDB(collection: IMongoCollection<Todo>) =
        this.AddSingleton<TodoFindFn>(find collection) |> ignore
        this.AddSingleton<TodoSaveFn>(save collection) |> ignore
        this.AddSingleton<TodoDeleteFn>(delete collection) |> ignore
